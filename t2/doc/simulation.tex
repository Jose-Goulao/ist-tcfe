...
In this subsection, the frequency response on $V_s$ and on node $n6$ is computed.
...
By contrast the magnitude and phase of $V_6$ change with frequency. At low frequencys $V_6$ is in phase with $V_s$ but as the frequency increases, the phase shift also increases. The magnitude starts at a value of around 1.065 than $V_s$ and with increasing value it decreases until it hits a plateau at around -5.275.
