...
Table \ref{tab:op1} shows the simulated operating point results for Circuit T1.
...
branches: $V_b$ = $v(n5,n2)$; $V_d$ = $v(n5,n8)$; the voltage drop in $C$ is equal to $v(n6,n8)$
...
Table \ref{tab:op2} shows the simulated operating point results for Circuit T1.
